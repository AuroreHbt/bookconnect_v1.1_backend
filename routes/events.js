...
/* router.post("/addevent", async (req, res) => {
    console.log("Requête body :", req.body);  // Ajoute ce log pour déboguer
  try {
...
router.post("/addevent", async (req, res) => {
    ...
    try {
      // Parser le champ eventData en JSON
      const eventData = JSON.parse(req.body.eventData);
      console.log("Données de l'événement :", eventData); // Affiche les données après parsing
